				...
				<div class="row">
					<div class="col-xs-6">
						<div class="b-homeAuto__latest">
							<h5 class="s-titleBg wow zoomInLeft" data-wow-delay="0.3s">site touristique de l’île</h5><br />
							<h2 class="s-title wow zoomInLeft" data-wow-delay="0.3s">En terres volcaniques</h2>
								...
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<div class="b-auto__main-item wow zoomInUp" data-wow-delay="0.3s">
											...
											<div class="b-world__item-val">
												<span class="b-world__item-val-title"> Le célèbre volcan réunionnais</span>
											</div>
											<h2>Le Piton de la Fournaise</h2>
									...
									<div class="col-md-6 col-sm-12">
										<div class="b-auto__main-item wow zoomInUp" data-wow-delay="0.3s">
											...
											<h2><a href="detail.html">Randonnée au Piton des Neiges</a></h2>
											<div class="b-auto__main-item-info">
								...
								<div class="row">
									<div class="col-sm-7 col-xs-12">
										<div class="b-homeAuto__world-item-info">
											<h2>
												<a href="article.html">Des visites incontournables sur l'île de la Réunion
												</a>
											</h2>
											<div class="b-world__item-val">
							...
							<div class="b-homeAuto__world-item wow zoomInUp" data-wow-delay="0.3s">
								<div class="row">
									<div class="col-xs-12 col-sm-7">
										<div class="b-homeAuto__world-item-info">
											<h2>
												<a> La Réunion, une île tropicale les pieds dans le lagon et la tête dans les étoiles
												</a>
											</h2>
											<div class="b-world__item-val">
												<div class="b-world__item-val-circles">
